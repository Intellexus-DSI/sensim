...
result_filenameA=("A-Gold-Synthetic-AnglE-SBERT.csv")
result_filenameA_Cross=("A-Synthetic-Gold-Cross.csv")
model_dirA=("ckpts/sts-b/A-Gold")
...
result_filenameB=("B-Gold-Synthetic-AnglE-SBERT.csv")
result_filenameB_Cross=("B-Synthetic-Gold-Cross.csv")
model_dirB=("ckpts/sts-b/B-Gold")
...
result_filenameC=("C-Gold-Synthetic-AnglE-SBERT.csv")
result_filenameC_Cross=("C-Synthetic-Gold-Cross.csv")
model_dirC=("ckpts/sts-b/C-Gold")
...
result_filenameD=("D-Gold-Synthetic-AnglE-SBERT.csv")
result_filenameD_Cross=("D-Synthetic-Gold-Cross.csv")
model_dirD=("ckpts/sts-b/D-Gold")
...
cartesian_product run_experimentAOnAnglE modals pooling epochs learning_rate cosine_w data_dirA train_dirA train_filenameA_Gold validation_filenameA test_filenameA test2_filenameA result_filenameA train_filenameA_Synthetic model_dirA
cartesian_product run_experimentAOnAnglE modals pooling epochs learning_rate cosine_w data_dirB train_dirB train_filenameB_Gold validation_filenameB test_filenameB test2_filenameB result_filenameB train_filenameB_Synthetic model_dirB
#cartesian_product run_experimentAOnAnglE modals pooling epochs learning_rate cosine_w data_dirC train_dirC train_filenameC_Gold validation_filenameC test_filenameC test2_filenameC result_filenameC train_filenameC_Synthetic model_dirC
#cartesian_product run_experimentAOnAnglE modals pooling epochs learning_rate cosine_w data_dirD train_dirD train_filenameD_Gold validation_filenameD test_filenameD test2_filenameD result_filenameD train_filenameD_Synthetic model_dirD

# 2. SBERT Runs (12 arguments: modal, pooling, epochs, lr, data, train_dir, train1, val, test1, test2, result, train2)
#cartesian_product run_experimentAOnSBERT modals pooling epochs learning_rate data_dirA train_dirA train_filenameA_Gold validation_filenameA test_filenameA test2_filenameA result_filenameA train_filenameA_Synthetic model_dirA
#cartesian_product run_experimentAOnSBERT modals pooling epochs learning_rate data_dirB train_dirB train_filenameB_Gold validation_filenameB test_filenameB test2_filenameB result_filenameB train_filenameB_Synthetic model_dirB
#cartesian_product run_experimentAOnSBERT modals pooling epochs learning_rate data_dirC train_dirC train_filenameC_Gold validation_filenameC test_filenameC test2_filenameC result_filenameC train_filenameC_Synthetic model_dirC
#cartesian_product run_experimentAOnSBERT modals pooling epochs learning_rate data_dirD train_dirD train_filenameD_Gold validation_filenameD test_filenameD test2_filenameD result_filenameD train_filenameD_Synthetic model_dirD
