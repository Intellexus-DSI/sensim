...
epochs=("3" "5" "7" "9")
pooling=("mean" "last" "avg" "max" "all")
#cosine_w=("0.02" "0.01" "0.001")
#ibn_w=("1.0" "0.1" "0.01")
#fitting=("" "--no_fit")
angle_w=("0.01" "0.02" "0.03")
cosine_tau=("10" "20" "20")
...
run_experiment() {
    ...
    python angle.py --hf_base_model "$1" --pooling "$2" --epochs "$3" --angle_w "$4" --cosine_tau "$5"
}

# Generate all combinations
# cartesian_product run_experiment modals learning_rates epochs pooling cosine_w ibn_w
cartesian_product run_experiment modals pooling epochs angle_w cosine_tau
