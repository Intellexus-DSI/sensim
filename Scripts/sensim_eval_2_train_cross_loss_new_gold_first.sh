...
result_filenameA_Cross=("A-Gold-Synthetic-Cross-new-loss.csv")
model_dirA=("ckpts/sts-b/A-Gold-cross-new-loss")
...
result_filenameB_Cross=("B-Gold-Synthetic-Cross-new-loss.csv")
model_dirB=("ckpts/sts-b/B-Gold-cross-new-loss")
...
result_filenameC_Cross=("C-Gold-Synthetic-Cross-new-loss.csv")
model_dirC=("ckpts/sts-b/C-Gold-cross-new-loss")
...
result_filenameD_Cross=("D-Gold-Synthetic-Cross-new-loss.csv")
model_dirD=("ckpts/sts-b/D-Gold-cross-new-loss")
...
run_experimentAOnCrossEncoder() {
    ...
    python cross_sbert_new_loss.py --hf_base_model "$1" --epochs "$2" --learning_rate "$3" --data_dir "$4" --train_dir "$5" --train_filename "$6" --validation_filename "$7" --test_filename "$8" --test2_filename "$9" --results_filename "${10}" --train2_filename "${11}" --model_dir "${12}"
}
# With Fit
...
cartesian_product run_experimentAOnCrossEncoder modalsCross epochs learning_rate data_dirA train_dirA train_filenameA_Gold validation_filenameA test_filenameA test2_filenameA result_filenameA_Cross train_filenameA_Synthetic model_dirA
cartesian_product run_experimentAOnCrossEncoder modalsCross epochs learning_rate data_dirB train_dirB train_filenameB_Gold validation_filenameB test_filenameB test2_filenameB result_filenameB_Cross train_filenameB_Synthetic model_dirB
cartesian_product run_experimentAOnCrossEncoder modalsCross epochs learning_rate data_dirC train_dirC train_filenameC_Gold validation_filenameC test_filenameC test2_filenameC result_filenameC_Cross train_filenameC_Synthetic model_dirC
cartesian_product run_experimentAOnCrossEncoder modalsCross epochs learning_rate data_dirD train_dirD train_filenameD_Gold validation_filenameD test_filenameD test2_filenameD result_filenameD_Cross train_filenameD_Synthetic model_dirD
