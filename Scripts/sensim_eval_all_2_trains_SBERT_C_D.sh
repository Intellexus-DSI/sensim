...
result_filenameA=("A-Synthetic-Gold-AnglE-SBERT-new.csv")
result_filenameA_Cross=("A-Synthetic-Gold-Cross-new.csv")
model_dirA=("ckpts/sts-b/A-Synthetic-new")
...
result_filenameB=("B-Synthetic-Gold-AnglE-SBERT-new.csv")
result_filenameB_Cross=("B-Synthetic-Gold-Cross-new.csv")
model_dirB=("ckpts/sts-b/B-Synthetic-new")
...
result_filenameC=("C-Synthetic-Gold-AnglE-SBERT-new.csv")
result_filenameC_Cross=("C-Synthetic-Gold-Cross-new.csv")
model_dirC=("ckpts/sts-b/C-Synthetic-new")
...
result_filenameD=("D-Synthetic-Gold-AnglE-SBERT-new.csv")
result_filenameD_Cross=("D-Synthetic-Gold-Cross-new.csv")
model_dirD=("ckpts/sts-b/D-Synthetic-new")
