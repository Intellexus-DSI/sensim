...
result_filenameA_Cross=("A-Synthetic-Gold-Cross-new-loss.csv")
model_dirA=("ckpts/sts-b/A-Synthetic-cross-new-loss")
...
result_filenameB_Cross=("B-Synthetic-Gold-Cross-new-loss.csv")
model_dirB=("ckpts/sts-b/B-Synthetic-cross-new-loss")
...
result_filenameC_Cross=("C-Synthetic-Gold-Cross-new-loss.csv")
model_dirC=("ckpts/sts-b/C-Synthetic-cross-new-loss")
...
result_filenameD_Cross=("D-Synthetic-Gold-Cross-new-loss.csv")
model_dirD=("ckpts/sts-b/D-Synthetic-cross-new-loss")
